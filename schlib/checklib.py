...
parser = argparse.ArgumentParser(
    description="Checks KiCad library files (.lib) against KiCad Library Convention (KLC) rules. You can find the KLC at http://kicad-pcb.org/libraries/klc/"
)
parser.add_argument("libfiles", nargs="+")
parser.add_argument(
    "-c",
    "--component",
    help="Check only one or more specific component(s) (implicitly verbose). Use comma separated values to select multiple components",
    action="store",
)
parser.add_argument(
    "-p",
